...
export default class MoviesDAO {
  ...
  static async getMoviesByCountry(countries) {
    ...
    */
    ...
    try {
      ...
      // const countries = ["USA","Italy","China","Germany"];
  ...
  static async facetedSearch({
    ...
    */
    ...
    try {
      let results = await (await movies.aggregate(queryPipeline)).next()
      // page=0?results:results.concat(skipStage);
      // results.length=20?results:results.concat(limitStage);
        ...
        },
  {
    '$lookup': {
      ...
      // let matchError = "E11000 duplicate key error collection"
      if (e){
